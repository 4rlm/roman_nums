...
Gem::Specification.new do |spec|
  spec.name          = "roman_nums"
  spec.version       = RomanNums::VERSION
  spec.authors       = ["Adam Booth"]
  spec.email         = ["4rlm@protonmail.ch"]

  spec.summary       = %q{Converts your input numbers to roman numerals.}
  spec.description   = %q{Converts your input numbers to roman numerals.}

  spec.homepage      = 'https://github.com/4rlm/roman_nums'
  spec.license       = "MIT"
